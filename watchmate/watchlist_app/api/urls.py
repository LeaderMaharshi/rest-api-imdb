...
urlpatterns = [
    ...
    path('stream/<int:pk>/review-create', views.ReviewCreate.as_view(), name='review_create'),
    path('stream/<int:pk>/review/', views.StreamPlatformDetailsAV.as_view(), name='stream_details'),
